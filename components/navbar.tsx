      ...
      {NAVLINKS.map((item) => {
        const Comp = (
          <Anchor
            ...
            absolute
            className="nav-link flex items-center gap-1 text-md font-medium"
            href={item.href}
          >
            {item.title}
          </Anchor>
