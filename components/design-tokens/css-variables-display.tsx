...
function ColorSwatch({ color, size = 40 }: { color: string; size?: number }) {
  return (
    <div
      className="border border-primary rounded-4 w-space-120"
      style={{
        height: size,
...
function RadiusPreview({ radius }: { radius: string }) {
  return (
    <div
      className="border border-primary bg-secondary w-space-120 min-w-space-40 h-space-40 min-h-space-40"
      style={{
        borderRadius: radius,
      }}
    />
...
function SpacingPreview({ spacing }: { spacing: string }) {
  return (
    <div
      className="bg-inverse rounded-4 h-space-12"
      style={{
        width: spacing,
      }}
    />
...
function StrokePreview({ stroke }: { stroke: string }) {
  return (
    <div
      className="bg-inverse rounded-4 w-space-120"
      style={{
        height: stroke,
      }}
    />
