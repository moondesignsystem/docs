...
<div className="w-full bg-primary h-[320px] flex items-center justify-center border border-primary gap-4 rounded-8 not-prose">
  <div className="moon-avatar">MD</div>
</div>
...
<Files
  items={[
    ...
    },
    {
      ...
      name: "CSS",
      subtype: "css",
      href: "https://ui.moondesignsystem.com/?path=/docs/content-display-avatar--docs",
    },
    {
      type: "file",
      name: "React",
      subtype: "react",
      href: "https://react.moondesignsystem.com/?path=/docs/content-display-avatar--docs",
    },
    {
      type: "file",
      name: "LiveView",
      subtype: "elixir",
      href: "https://liveview.moondesignsystem.com/content_display/avatar",
    },
  ]}
/>
