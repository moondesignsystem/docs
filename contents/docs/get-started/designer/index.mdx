...
'MDS Core' is the foundational library for theming. It contains only styles and variables, there are no UI components. This library is designed to be used as a source of truth for multiple different products through the use of variable modes.
